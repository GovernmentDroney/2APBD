...
public class AdvancedEmpDeptTests
{
    ...
    public void ShouldReturnMinSalaryInDept30()
    {
        ...
        decimal? minSalary = emps.Where(emp=> emp.DeptNo.Equals(30)).Min(emp => emp.Sal);
    ...
    public void ShouldReturnEmployeesWithManagers()
    {
        ...
        var withMgr = emps.Where(emp => emp.Mgr.HasValue).ToList(); 
        
        Assert.All(withMgr, e => Assert.True(e.Mgr.HasValue));
    }
    ...
    public void AllEmployeesShouldEarnMoreThan500()
    {
        ...
        var result = emps.Where(emp => emp.DeptNo > 500).ToList(); 
        
        Assert.All(result, e => Assert.True(e.DeptNo > 500));
    }
    ...
    public void ShouldFindAnyWithCommissionOver400()
    {
        ...
        var result = emps.Where(emp => emp.Comm > 400).ToList(); 
    ...
    public void ShouldReturnEmployeeManagerPairs()
    {
        ...
        var result = (from emp in emps
                join emp2 in emps on emp.Mgr equals emp2.EmpNo
                select new {Employee = emp.EName, Manager = emp2.EName}).ToList();
    ...
    public void ShouldReturnTotalIncomeIncludingCommission()
    {
        ...
        var result = (from emp in emps select new{EName = emp.EName, Total = emp.Sal + emp.Comm }) ; 
